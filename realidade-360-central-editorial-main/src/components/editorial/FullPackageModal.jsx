...
const STEPS = [
  ...
  { key: 'checagem', label: 'Executando Checagem 360 e suporte documental...' },
      ...
      <div className="w-full max-w-lg rounded-2xl border border-white/10 bg-[#0b1424] p-6 shadow-2xl">
        ...
        {stepIdx === -1 ? (
          <div className="space-y-4">
            <p className="text-sm leading-relaxed text-slate-300">Vamos executar o fluxo assistido: apuração → conteúdo → Checagem 360 → suporte documental → arte padrão → rascunho → revisão final. Você poderá revisar tudo antes de aprovar.</p>
